...
function loop() {
  ...
  while (!r.WindowShouldClose()) {
    ...
    textureMode(x, y, snakeWidth, snakeHeight, foodX, foodY, foodWidth, foodHeight, score);
    // draw(x, y, rectangleWidth, rectangleHeight, foodX, foodY, foodWidth, foodHeight);
  }


  function textureMode(x, y, snakeWidth, snakeHeight, foodX, foodY, foodWidth, foodHeight, score) {
